...
from scripts.exceptions import InvalidBackboneError


class ResNetSimCLR(nn.Module):

    def __init__(self, base_model, pretrained, num_classes, out_dim=128):  # <fix>
        super(ResNetSimCLR, self).__init__()
        if pretrained:  # <fix>, num_classes=out_dim just use for contrastive head
        ...
        # <fix>, need to separate ResNet's backbone and fc
