...
def makeTinyimagenetRotation(num, list, teset_raw, teset_label_raw, args):
# for num in trange(num_sets):
    if num <= num_sets * 3 / 20:  # <fix>
...
if args.workers > 1:
    ...
    for num in range(num_sets):
        makeTinyimagenetRotation(num, list, teset_raw, teset_label_raw, args)
